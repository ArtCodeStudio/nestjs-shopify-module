 ...
 */
export interface IShopifySyncTransactionListOptions
  extends Options.TransactionListOptions,
    ISyncOptions {}
export interface IShopifySyncTransactionGetOptions
  extends Options.TransactionGetOptions,
    ISyncOptions {}
export type IShopifySyncTransactionCountOptions =
